...
#include "activities/canto/CantoSettingsActivity.h"
...
void SettingsActivity::rebuildSettingsLists() {
  ...
  systemSettings.push_back(SettingInfo::Action(StrId::STR_CANTO, SettingAction::Canto));
  ...
  if (setting.type == SettingType::TOGGLE && setting.valuePtr != nullptr) {
    ...
    switch (setting.action) {
      ...
      case SettingAction::KOReaderSync:
        ...
        break;
      case SettingAction::Canto:
        startActivityForResult(std::make_unique<CantoSettingsActivity>(renderer, mappedInput), resultHandler);
        break;
